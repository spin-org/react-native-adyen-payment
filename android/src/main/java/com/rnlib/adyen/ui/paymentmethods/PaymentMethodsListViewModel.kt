...
import com.rnlib.adyen.checkPaymentMethodAvailability
import com.rnlib.adyen.ui.stored.makeStoredModel
        ...
        for (paymentMethod in paymentMethods) {
            ...
            when {
                ...
                PaymentMethodTypes.SUPPORTED_PAYMENT_METHODS.contains(type) -> {
                    ...
                    checkPaymentMethodAvailability(getApplication(), paymentMethod, adyenComponentConfiguration, this)
                }
                else -> {
                    availabilitySkipSum++
