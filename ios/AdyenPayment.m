...
RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(canMakeApplePayPayments)
{
    return @([PKPaymentAuthorizationViewController canMakePaymentsUsingNetworks:@[PKPaymentNetworkVisa, PKPaymentNetworkAmex, PKPaymentNetworkMasterCard, PKPaymentNetworkDiscover]]);
}
@end
